...
bool interfaces__msg__attitude__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._attitude.Attitude", full_classname_dest, 33) == 0);
  }
  interfaces__msg__Attitude * ros_message = _ros_message;
  {  // roll
  ...
  {  // rollspeed
    ...
    assert(PyFloat_Check(field));
    ros_message->rollspeed = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pitchspeed
    ...
    assert(PyFloat_Check(field));
    ros_message->pitchspeed = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // yawspeed
    ...
    assert(PyFloat_Check(field));
    ros_message->yawspeed = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * interfaces__msg__attitude__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._attitude");
